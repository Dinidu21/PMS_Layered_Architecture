    ...
    public void changeOnClick(ActionEvent actionEvent) {
        ...
        if (!firstName.getText().isEmpty()) {
            if (firstName.getText().matches("[a-zA-Z]+")) {
                userDTO.setFull_name(firstName.getText() + (userDTO.getFull_name() != null ? " " + userDTO.getFull_name().split(" ")[1] : ""));
                hasUpdates = true;
            } else {
        ...
        if (!lastName.getText().isEmpty()) {
            if (lastName.getText().matches("[a-zA-Z]+")) {
                userDTO.setFull_name((userDTO.getFull_name() != null ? userDTO.getFull_name().split(" ")[0] : "") + " " + lastName.getText());
                hasUpdates = true;
            } else {
